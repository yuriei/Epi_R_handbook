...
**Each page is stored within its own Rmarkdown file in the "pages" folder of the R project.** You can make a new page using the file `_template.Rmd`.  

Each page can be knitted on its own, as in this case the page will source the `page_setup.Rmd` file to load the datasets and default settings.  
...
* If you want to work on your page: open it and edit it, then knit it individually and examine your work, and make sure it is included as a chunk within `handbook_combined.Rmd`.  
