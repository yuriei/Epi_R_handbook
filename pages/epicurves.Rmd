...
#### Aggregate linelist data  
<h4> Aggregate linelist data   </h4>
...
1) use `floor_date = TRUE` and `factor = TRUE` in the `date2week()` command, and  
...
```{r, eval=F}
linelist <- linelist %>% 
  mutate(week = aweek::date2week(date_onset, floor_day = T, factor = TRUE))
