...
```{r datasets_import_silent, cache=T}
# import linelist
linelist_raw <- rio::import(here::here("unified", "data", "fluH7N9_China_2013.csv"))  

# import aggregated case counts of disease X
count_data <- rio::import(here::here("unified", "data", "aggregated_counts_diseaseX.xlsx"))  
...
knitr::include_graphics(here::here("unified", "images", "RStudio_overview.png"))
```
...
<!-- ======================================================= -->
<!-- ======================================================= -->
## Working directory {.tabset .tabset-fade .tabset-pills}
...
```{r basics_objects_structures, out.width = "100%", fig.align = "center"}
knitr::include_graphics(here::here("unified", "images", "R_data_structures.png"))
```  
...
knitr::include_graphics(here::here("unified", "images", "Calling_Names.gif"))
```  


<!-- ======================================================= -->
### Objects have Classes  {#Object-Classes}
...
```{r basics_objects_class, echo=TRUE, eval=F}
...
```{r basics_functions_image, out.width = "75%", fig.align = "center"}
knitr::include_graphics(here::here("unified", "images", "Function_Bread_Example.png"))
```
...
```{r basics_functions_arguments, include=FALSE, results='hide', message=FALSE, warning=FALSE, eval=F}
...
```{r basics_functions_pyramid, message=FALSE, warning=FALSE, eval=F}
...
``` {r basics_functions_pipes, eval=FALSE}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Piping functions {.tabset .tabset-fade .tabset-pills}

Two general ways of approaching coding are: 

**Re-defining objects**
as changes are made - 
still handy to know

Risks: creating new objects for each step - 
...
Combine all functions together - difficult to read
...
cake <- flour %>%       # start with an object
  left_join(eggs) %>% 
  left_join(oil) %>% 
  left_join(water) %>% 
  mix_together(utensil = spoon, minutes = 2) %>% 
  bake(degrees = 350, system = "fahrenheit", minutes = 35) %>% 
  let_cool()
```
...
3) You can also use the *base R* command `file.choose()` (leaving the parentheses empty) to trigger appearance of a pop-up window that allows the user to manually select a file from their computer. For example:  
...
See section on [object classes](#Object-Classes)   

See section on [object classes] \@ref(Classes)
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Common error messages {.tabset .tabset-fade .tabset-pills}
