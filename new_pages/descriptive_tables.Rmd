...
This page demonstrates the use of **janitor**, **dplyr**, and **gtsummary** to produce tables and descriptive statistics. Each of these tools have advantages and disadvantages in the areas of code simplicity, accessibility of outputs, quality of printed outputs. We hope one of these approaches works for you.  
...
#### Using `summarise()` on aggregated data {-}  
