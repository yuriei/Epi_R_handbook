...
In this page we will cover tips and tricks to make your plots sharp and fancy. See the page on [Plotting with ggplot] for the fundamentals.  
...
Here is an example from the [Plotting with ggplot] page, saved as ```using various color schemes. 
...
Faceting is described in the [Plotting with ggplot] page.  
