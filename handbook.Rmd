...
* A relative filepath: `import(here("data", "linelists", "ebola_linelist.xlsx"))`  
  ...
  * Best if working within an R project, or sharing a project with others  
...
The first method shown uses the package **ggupset**. More information can be found [online](https://rdrr.io/cran/ggupset/man/scale_x_upset.html) or offline in the package documentation in your RStudio Help tab.
...
linelist_sym <- linelist %>% 
  mutate(fever  = sample(c("yes", "no"), nrow(linelist), replace = T, prob = c(0.80, 0.47)),
         chills = sample(c("yes", "no"), nrow(linelist), replace = T, prob = c(0.60, 0.80)),
         cough  = sample(c("yes", "no"), nrow(linelist), replace = T, prob = c(0.75, 0.20)),
         aches  = sample(c("yes", "no"), nrow(linelist), replace = T, prob = c(0.45, 0.47)),
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Missing Data {#missing .tabset-fade}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# if/else/loops  {#ifelse .tabset-fade}
