...
<!-- ======================================================= -->
<!-- ======================================================= -->
# R Markdown {#rmarkdown .tabset .tabset-fade}  
...
* The Rmarkdown package, which coverts Rmd files into a range of different outputs. ```install.packages('rmarkdown')```
* Pandoc, which is a document converter. This comes with RStudio. If you are not using RStudio, you can download it here: http://pandoc.org. 
