...
pacman::p_load(rio,       # to import data
               ...
               PHEindicatormethods)
```
<span style="color: darkgreen;">**_NB:_** you may get an error that the **dsr** package is not available if you try to install it (if you are using a newer version of R), as it has recently been removed from the CRAN repository. However, older versions have been archived, so you can download and use those.</span>
