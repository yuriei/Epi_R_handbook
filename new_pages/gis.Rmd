...
sle_adm3_dat <- sle_adm3 %>% 
  inner_join(case_adm3, by = "admin3name") # inner join = retain only if in both data objects
...
We can quantify adjacency relationships between administrative region polygons in the `sle_adm3` data we have been using with the **spdep** package:
