...
```{r, phylogenetic_trees_adding_sampledata, out.width=c('120%'),fig.align='center', message=FALSE}
...
```{r, phylogenetic_trees_subsetting, out.width=c('70%'), fig.show='hold', fig.align='center'}
...
```{r, phylogenetic_trees_rotating_1, out.width=c('70%'), fig.show='hold', fig.align='center'}
...
```{r, phylogenetic_trees_inspect_subset_example, out.width=c('80%'), fig.show='hold', fig.align='center', message = FALSE}
...
```{r, phylogenetic_trees_sampledata_heatmap_gender, out.width=c('70%'), fig.show='hold', fig.align='center', message = FALSE}
...
```{r, phylogenetic_trees_sampledata_heatmap_cip_MIC, out.width=c('70%'), fig.show='hold', fig.align='center', message = FALSE}
...
```{r, phylogenetic_trees_sampledata_heatmap_linear, out.width=c('80%'), fig.show='hold', fig.align='center', message = FALSE}
# B: Lineartree:
