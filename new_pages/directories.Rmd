...
To list the full file paths of the directory's files, you can use you can use `dir_ls()` from **fs**.  
...
* Splitting a dataframe and saving it out as multiple CSV files  
