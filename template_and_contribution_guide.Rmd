...
*This is a collaborative project. Any contributions you make are offered to the Core Team and subject to editorial changes. So please don't be offended if your code, content, or wording is changed or even removed. We welcome hearing your point of view regarding any changes you disagree with.*  

*Also please note that your work will be accessed and distributed widely in this handbook. It may or may not be credited. Just be glad that you are helping others leverage R for epidemiology and other good works.*
...
A few additional points on Rmarkdown style for this handbook:  
* 
...
* There is a REMOTE version of the `R_epi_hanbook` R project that lives on Github website repository - master and other branches all exist and are viewable on this Github repository. Pull requests, issue tracking, and de-conflicting merges happens online here.  
...
5) **Become a contributor** to the [R_epi_handbook Github repository](https://github.com/nsbatra/R_epi_handbook) (email neale.batra@gmail.com)
6) **Clone** the Github repository to your computer  
     * In RStudio start a new project *File > New Project > Version Control > Git*  
     * In “Repository URL”, paste the URL *https://github.com/nsbatra/R_epi_handbook.git* (link also available from repo main page, green "Code" button, HTTPS)
...
* Go to R_epi_handbook Github repository  
