...
The handbook focusses on the **dplyr** “verb” functions and the **magrittr** pipe operator %>% as a method to clean and group data, but the **data.table** package offers an alternative method, with the goal of creating clean and readable code.

This page will explore some of the core functions of data.table using the Ebola case linelist, referenced throughout the handbook.
