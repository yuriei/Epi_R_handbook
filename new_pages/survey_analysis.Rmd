...
for detailed coe and R-markdown templates see the ["R4Epis" github page](https://github.com/R4EPI/sitrep). 
...
survey_data <- survey_data %>% 
  filter(!is.na(surv_weight_cluster_strata))
```
...
gtsummary::tbl_svysummary(base_survey_design, 
               include = c(arrived, left, died, education_level), 
...
tab_survey(survey_design, died, deff = TRUE, keep = "TRUE")
