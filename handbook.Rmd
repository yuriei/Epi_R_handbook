---
title: "R Handbook for Epidemiologists (1 Rmd file)"
author: "Neale Batra"
...
<!-- ======================================================= -->
## Datasets used in this handbook {#datasets}
...
pacman::p_load(tidyverse, rio, here, apyramid)
```


```{r datasets_import_silent, echo = F, cache=T}
# import linelist
linelist_raw <- rio::import(here::here("data", "fluH7N9_China_2013.csv"))
...
The latest version of this handbook lives in the "Unified" folder at this [github repository](https://github.com/nsbatra/R_epi_handbook).  

You can learn more in this handbook about [using R and Github](#github)
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# R Basics {#rbasics .tabset .tabset-fade .tabset-pills}
...
```{r basics_RStudio, out.width = "100%", fig.align = "center"}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
## Working directory {#workingdirectory .tabset .tabset-fade .tabset-pills}
...
```{r basics_objects_structures, echo=F, out.width = "100%", fig.align = "center"}
...
linelist$age_group <- cut(linelist$age, breaks = c(0, 3, 15, 30, 45, 60))
```
...
```{r basics_functions_pyramid, message=FALSE, warning=FALSE, eval=T}
...
```{r, basics_functions_pyramid2, eval = FALSE, warning=FALSE, message=FALSE, eval=F}
...
Other resources and online training/courses for introductory R skills
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Piping (`%>%`) {#piping .tabset .tabset-fade .tabset-pills}
...
1) **piping an object from function to function** (usually within the "tidyverse")  
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Importing data {#importdata .tabset .tabset-fade .tabset-pills}


Introduction to importing data TODO
...
<!-- ======================================================= -->
## Relative filepaths {#here .tabset .tabset-fade .tabset-pills}

Any import function needs to be told the filepath of where to look on your computer to find the file. In some circumstances, it is very useful to use the package **here** and it's function `here()` within `import()`.  

The function `here()` from the package **here** makes it easy to locate files in a way that will not break when a script is run on different computers.

`here()` works best within [R projects](#rprojects). When the **here** package is first loaded, it automatically considers the top-level folder of your R project as “here” - a benchmark for all other files in the project.  
...
Below is an example of importing the file “fluH7N9_China_2013.csv”.  

If the file is in the folder which is designated by the benchmark “here”, all you have to do is provide the name of the file in quotes (with the appropriate ending).

```{r import_here_one, eval=F}
linelist <- import(here("fluH7N9_China_2013.csv"))
```

If however, your file is within subfolders of the folder designated as “here” - let’s say it is in the subfolder “data” - you write these folder names before the file name, in quotes, and separated by commas, as below:
```{r import_here_mutiple, eval=F}
linelist <- import(here("data", "fluH7N9_China_2013.csv"))
```

The `here()` command produces a character filepath, which is then processed by the `import()` function.
...
<span style="color: black;">**_NOTE:_** You can still import a specific sheet of an excel file as noted elsewhere. The `here()` command is only supplying the filepath.</span>
...
You can use tabs and spacing to make the data entry more intuitive and readable. For example:  
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Working with Dates {#dates .tabset .tabset-fade .tabset-pills}
...
The standard, **base** R function to convert an object or variable to class Date is `as.Date()` (not capitalization).  
...
**If used on a variable, `as.Date()` therefore requires that all the character date values be in the same format before converting.** [Read more about using `as.Date()` here](https://www.stat.berkeley.edu/~s133/dates.html).
...
<span style="color: darkgreen;">**_TIP:_** Also, be sure that in the `format=` argument you use the *date-part separator* (e.g. /, -, or space) that is present in your dates.</span>
...
or within piping (see REF): 

```{r eval=F}
linelist_cleaned %>% 
  mutate(as.Date(as.character(date_of_onset), format = "%d/%m/%Y"))
```
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Cleaning data {#cleaning .tabset .tabset-fade .tabset-pills}
...
Time zones
Shifting time (adding hours) example of WHO receiving reports of COVID from different time zones
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Transforming data {#transformation .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Grouping/aggregating data {#grouping .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Descriptive analyses {#descriptive .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
# Scatterplots {#scatterplot .tabset .tabset-fade .tabset-pills}

plot(linelist$age)


<!-- ======================================================= -->
# Boxplots {#boxplot .tabset .tabset-fade .tabset-pills}

These can be created simply, or with **ggplot2**  

```{r out.width=c('50%', '50%'), fig.show='hold'}
# boxplot function
graphics::boxplot(age ~ gender, data = linelist)

# ggplot2 function
ggplot(data = linelist, aes(y = age))+
  geom_boxplot()
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Simple Statistical Tests {#stat_tests .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Epidemic Curves {#epicurves .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Heatmaps {#heatmap .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Age pyramids {#agepyramid .tabset .tabset-fade .tabset-pills}
via ggplot and via R4Epis methods

<!-- ======================================================= -->
<!-- ======================================================= -->
<!-- ======================================================= -->
# Diagrams {#diagrams .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Making nice tables {#tables .tabset .tabset-fade .tabset-pills}
knitr::kable
DT
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Transmission Chains {#transmissionchains .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Survey analysis {#surveys .tabset .tabset-fade .tabset-pills}
Weighting?
Other?
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Time series analysis {#timeseries .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Rmarkdowns {#rmarkdown .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# GIS Basics {#gis .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Character search/Regex {#characters .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Matching/Merging datasets {#merging.tabset .tabset-fade .tabset-pills}
joins
antijoins, etc
dplyr
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Deduplicating {#dedup .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Moving averages {#movingaverage.tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Epidemic modeling {#epidemics .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# R projects {#rprojects .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# ggplot2 tips {#ggplot .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Modeling {#modeling .tabset .tabset-fade .tabset-pills}
Tidymodels
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# R with interactive console {#console .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Shiny basics {#shiny .tabset .tabset-fade .tabset-pills}
Flexdashboard  
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Connecting with relational databases {#databases .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# R on network/company drives {#networkdrive .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Report Factories {#reportfactory .tabset .tabset-fade .tabset-pills}


<!-- ======================================================= -->
<!-- ======================================================= -->
<!-- ======================================================= -->
# Github and R {#github .tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Interactive plots {#plotly .tabset .tabset-fade .tabset-pills}
plotly
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Common error messages {#errors .tabset .tabset-fade .tabset-pills}
