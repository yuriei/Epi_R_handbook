...
This is a free open-source R reference guide catered to applied epidemiologists. 
...
*"Epis" using R must often search online and read dozens of forum pages to complete common data manipulation and visualization tasks. Most online tutorials are not epidemiology-oriented. Furthermore, epidemiologists often work in low internet-connectivity environments and have limited technical support. This handbook aims to fill these gaps.*  


<!-- ======================================================= -->
## How to read this handbook {-} 

* Review pages and tabs with the Table of Contents  
...
* If you use and appreciate this resource, let us know HERE!  
...
<!-- ======================================================= -->
## Functions {#functions .tabset .tabset-fade }
...
```{r, out.height = "25%", fig.align = "center", echo=F}
...
See the page on importing data for more details. Here we import the raw .xlsx dataset using the `import()` function from the package **rio**, and save it initially as the dataframe object `linelist_raw`.  (LINK HERE TO IMPORT PAGE)  
...
*Note that in these examples we modify the column names and display the result, but do not assign/overwrite `lineline`.*  
...
As well as `everything()` there are several helpers that work *within* `select()`, namely:  
...
* to edit one specific value, for example a date with an incorrect year or format  
* to reconcile values that not spelled the same
