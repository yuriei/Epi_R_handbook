...
And then you can print this nicely with HTML - below is the output printed with **flextable**. You can read more in depth about this example and how to achieve this nice table in the [HTML tables] page.  
