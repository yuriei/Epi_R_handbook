...
We import the dataset of cases from a simulated Ebola epidemic. If you want to download the data to follow along step-by-step, see instruction in the [Download handbook and data] page.  
...
weekly_counts <- linelist %>% 
  ...
  tidyr::complete(
    week = seq.Date(                # ensure all weeks are present, even those with no cases reported
      ...
      to = max(week),
      by = "week"),
    fill = list(n = 0))             # fill-in NAs in new weeks with 0
```
