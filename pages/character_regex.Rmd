...
One solution to automatically make as many columns as needed is:  
...
Regex is a concise language for describing patterns in strings. If you are unfamiliar, it can look like an alien language:  
