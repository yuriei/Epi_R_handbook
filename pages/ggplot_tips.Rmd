...
<!-- ======================================================= -->
### basics of ggplot {.tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
### Themes and Labels {.tabset .tabset-fade .tabset-pills}
...
For example, we can update this plot like this:
...
delay_plot <- delay_plot + 
  ...
  # add nicer labels
  labs(x = "age", 
       y = "onset to hospitalsiation (days)",
...
<!-- ======================================================= -->
## Changing the order of discrete variables {.tabset .tabset-fade .tabset-pills}
...
<!-- ======================================================= -->
## Multiple plots {.tabset .tabset-fade .tabset-pills}
...
This can quickly become an overwhelming amount of information - its good to ensure you dont have too many levels of each variable that you choose to facet by!

*COMBINE WITH NEALES SECTION*?
...
The `cowplot` package has a fairly wide range of functions, but the easiest use of it can be achieved through the use of `plot_grid()`. This is effectively a way to arrange predefined plots in a grid formation.
...
For our example, we will make a scatterplot showing BMI against age. We're also going to label each point with a patient id when the patient is under 10 years of age. We'll use a trick with filter to only show these specific points!
...
ggplot(linelist_cleaned, 
  ...
  ggrepel::geom_text_repel(data = linelist_cleaned %>% filter(age_years <= 10),
                           aes(label = case_id),
                           force = 1) +
  labs(y = "bmi", x = "age in years")
