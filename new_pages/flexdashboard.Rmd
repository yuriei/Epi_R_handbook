...
Links to comprehensive tutorials on using **flexdashboard** can be found in the Resources section. Below we give a quick example of building a dashboard to explore the case `linelist` data.  
...
```
In the window that opens, select "From Template" and select the "Flex Dashboard" template.  

```{r out.width = "100%", fig.align = "center", echo=F}
knitr::include_graphics(here::here("images", "flexdashboard_new2.png"))
```

In this page's example, we will name out R Markdown as "outbreak_dashboard.Rmd".  

Alternatively, you can create the R Markdown with code like: TO DO command
