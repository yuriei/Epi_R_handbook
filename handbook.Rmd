...
linelist_sym <- linelist %>% 
  mutate(fever  = sample(c("yes", "no"), nrow(linelist), replace = T),
         chills = sample(c("yes", "no"), nrow(linelist), replace = T),
         cough  = sample(c("yes", "no"), nrow(linelist), replace = T),
         aches  = sample(c("yes", "no"), nrow(linelist), replace = T),
...
<!-- ======================================================= -->
<!-- ======================================================= -->
# Character search/Regex {#characters .tabset .tabset-fade}
