...
```{r, eval=T, echo=F}
linelist_cleaned <- rio::import(here::here("data", "case_linelists", "linelist_cleaned.rds"))
...
<span style="color: darkgreen;">**_TIP:_** Run `theme_get()` from **ggplot2** to print a list of all 90+ `theme()` options to the console.</span>  
