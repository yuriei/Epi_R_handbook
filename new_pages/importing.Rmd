...
TBD - Under construction (Sara has added some API retrieval snippets for Go.Data in case useful but feel free to disregard)
...
Below is some sample code using *httr* and *jsonlite* for connecting to the Go.Data API to pull in contact lists.
