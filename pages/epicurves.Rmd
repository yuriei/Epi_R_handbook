...
To change the legend, use `ggplot()` commands such as `theme(legend.position = "top", legend.direction = "horizontal", 
          legend.title = element_blank())`. See the page of ggplot() tips for more details.  
