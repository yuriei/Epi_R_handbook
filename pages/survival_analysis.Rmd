...
We can also use the `print()` function. The `print.rmean=TRUE` argument is used to obtain the mean survival time  which is often defined as the area under the survival curve and its standard error (se).
