...
Use `str_glue()` to combine strings and dynamic R code such as defined values. This is a very useful function for creating dynamic plot captions, as demonstrated below.  
...
```{r, echo=F}
DT::datatable(df_split, rownames = FALSE, filter="top", options = list(pageLength = 5, scrollX=T) )
```
