...
Below is a long list of suggested packages for common epidemiological work in R. You can copy this code, run it, and all of these packages will install and load for use in the current R session. If a package is already installed, it will be loaded for use.  
...
* If multiple packages have functions with the same name, *masking* can occur where the function from the more recently-loaded package takes precedent. Consider using the package **conflicted** to manage such conflicts.  
