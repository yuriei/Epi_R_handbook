...
Here is an example of a real function, where we are simulating a number of dice rolls. The input, number_of_dice_rolls is the number of dice rolls we would like to simulate. In the curly brackets we perform the operation:

```{r message=FALSE, warning=FALSE, out.width = "75%", out.height="75%"}
roll_dice <- function(number_of_dice_rolls){
  
  dice  <- seq(1:6) #create a vector with the number of possible outcomes of the dice
  total <- sum(sample(dice, size = number_of_dice_rolls, replace = TRUE)) 
  
  #sum the outcomes of the dice rolls
  #size is equal to number of rolls and setting replace = TRUE means the item sampled is replaced 
...
To simulate the total of 8 dice rolls you can call the function as follows:
