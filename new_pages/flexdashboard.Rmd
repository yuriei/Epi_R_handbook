...
In **flexdashboard**, a primary heading (one #) creates a "page" of the dashboard. Second-level headings (##) create a column or a row depending on your `orientation:` parameter (see details below). Third-level headings create panels for plots, charts, tables, text, etc. and are made with ###.   
