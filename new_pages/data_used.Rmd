...
To download the offline version of this handbook:  
...
4) The file is large (>40MB). When you open it, it may take time for images and the Table of Contents to appear on your screen. The offline handbook displays as one long page, so search for specific content with with Ctrl+f (Cmd-f).  
