...
* If you want to work on your page: open it, run the script `_page_setup.R` and edit it, then knit the page individually and examine your work, and make sure it is included as a chunk within `handbook_combined.Rmd`.  
