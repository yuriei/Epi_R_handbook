...
source(here::here("pages", "_page_setup.Rmd"))
```
...
Note in the above, that the factor order of "m" and "f" is different (pyramid reversed). To adjust the order you must re-define the levels of gender as a Factor.  
...
A **simple** version of this is below:
...
<!-- ======================================================= -->
## Likert Scale {.tabset .tabset-fade .tabset-pills}
