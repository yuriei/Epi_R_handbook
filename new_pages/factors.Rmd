...
In ggplot() use the drop = FALSE arguement in scale_x_discrete() (scale_fill_discrete, scale_color_discrete)
In janitor tables, all levels are shown automatically
In **dplyr** count() and summarise() use the `.drop = FALSE` argument to show all levels.
https://ggplot2.tidyverse.org/reference/scale_discrete.html
https://dplyr.tidyverse.org/reference/count.html
See Contact Tracing page
